 ...
 * WDS GROUP
 *
 * @name        AbstractNestedSetModel.php
 * @category    Wds
 * @package     Wds_AbstractNestedSetModel
...
use Wds\NestedSetModel\NestedSetModel;

class AbstractNestedSetModel implements NestedSetModel {
     ...
     * @access	public
	 */
	public function AbstractNestedSetModel()
	{		
